...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <?php
                include("conexao.php");/*conexão como banco*/
                $recebeid=$_GET["editaid"];
                /*recebe id passado via GET*/
                $seleciona=mysqli_query($conexao, "SELECT * FROM dados WHERE id=$recebeid");
                /*seleciona tudo da tabela dados onde id=recebeid, gravando tudo na variavel seleciona*/
                $campo=mysqli_fetch_array($seleciona);
                /*mysqli_fetch_array, eu pego cada item que esta dentro a variavel seleciona e armazeno em $campo*/
            ?>
            <form action="gravaedita.php" method="post">
                <!--db_view contem as variais recebidas dos names-->
                <div class="row">
                    <div class="col-md-6">
                        <h2 style="color: white; margin: 50px;">Formulário de Edição</h2>
                    </div>
                </div>
                ...
                <div class="row g-3 needs-validation" novalidate>
                    <div class="col-md-4">
                        ...
                        <input type="text" id="nome" name="nome" class="form-control" placeholder="Nome"
                            aria-label="First name" required value="<?=$campo["nome"]?>">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="msg" name="msg" class="form-control" placeholder="obs.:"
                            aria-label="First name" required value="<?=$campo["msg"]?>">
                    </div>
                </div>
                <br>
                <center>
                    <button class="btn btn-primary" type="submit" value="GRAVAR">Salvar</button>
                </center>
            </form>
        </div>
        <!-- fim container -->
